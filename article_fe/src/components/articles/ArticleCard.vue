...
const excerpt = computed(() => {
  ...
  // Buat element sementara untuk strip HTML
...
<template>
  <div
    class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-300"
  >
    <!-- Cover / Thumbnail -->
    ...
    <div class="p-5">
      ...
      <!-- Excerpt (jika ada) -->
      <p v-if="excerpt" class="text-sm text-gray-600 line-clamp-3 mb-4">
        {{ excerpt }}
      </p>
