  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div v-if="profileStore.loading" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 sm:p-8 animate-pulse">
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <div class="h-32 bg-gradient-to-r from-blue-500 to-blue-600 relative">
            <button
              ...
              class="absolute top-4 right-4 px-4 py-2 bg-white/20 backdrop-blur-md text-white text-sm font-medium rounded-lg hover:bg-white/30 transition-all flex items-center gap-2"
            >
          ...
          <div class="px-6 sm:px-8 pb-8">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-end gap-6 -mt-16 mb-6">
              ...
              <div class="relative group">
                <div
                  v-if="avatarUrl"
                  class="w-32 h-32 rounded-2xl shadow-xl border-4 border-white flex items-center justify-center flex-shrink-0 overflow-hidden"
                >
                  <img :src="avatarUrl" alt="Avatar" class="w-full h-full object-cover" />
                </div>
                <div
                  v-else
                  class="w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl shadow-xl border-4 border-white flex items-center justify-center flex-shrink-0"
                >
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-3">{{ profileStore.profile?.email }}</p>
            ...
            <!-- Quick Actions -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-6 border-t border-gray-200">
              <button
                @click="startChangePassword"
                class="flex items-center justify-center gap-2 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl hover:bg-gray-100 hover:border-gray-300 transition-all text-sm font-medium text-gray-700"
              >
              ...
              <button
                @click="startEditProfile"
                class="flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 border border-blue-200 rounded-xl hover:bg-blue-100 hover:border-blue-300 transition-all text-sm font-medium text-blue-700"
              >
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
