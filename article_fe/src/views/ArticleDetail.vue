...
onMounted(() => {
  articleStore.fetchArticleDetail(route.params.id)
})
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <!-- Skeleton Loader -->
      <div v-if="articleStore.loading" class="bg-white rounded-2xl shadow-sm overflow-hidden">
      ...
      >
        <!-- Featured Image Placeholder (optional - tambahkan jika ada) -->
        <div class="h-64 sm:h-80 bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        ...
        <div class="p-6 sm:p-8 lg:p-12">
          ...
          <div class="flex flex-wrap items-center gap-3 text-sm mb-6">
            <span class="inline-flex items-center px-3 py-1 bg-blue-50 text-blue-700 font-medium rounded-full">
            ...
            <div class="flex items-center gap-2 text-gray-600">
              ...
              <span>{{ articleStore.articleDetail.fullname || articleStore.articleDetail.author }}</span>
            </div>
            <span class="text-gray-300" v-if="articleStore.articleDetail.created_at">•</span>
            <div class="flex items-center gap-2 text-gray-600" v-if="articleStore.articleDetail.created_at">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="pt-8 space-y-8">
            ...
            <div class="flex items-center gap-4">
              <LikeButton :articleId="articleStore.articleDetail.id" />
            </div>
            ...
            <div class="bg-gray-50 rounded-2xl p-6">
              ...
              <CommentList :articleId="articleStore.articleDetail.id" />
            </div>
          </div>
        </div>
      </article>
      ...
      <div v-else class="flex flex-col items-center justify-center py-16 sm:py-24">
        <div class="w-24 h-24 sm:w-32 sm:h-32 bg-red-100 rounded-full flex items-center justify-center mb-6">
          <svg class="w-12 h-12 sm:w-16 sm:h-16 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
